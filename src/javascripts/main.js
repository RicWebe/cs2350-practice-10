...
let initial_cards =[
  ...
  function displayCards(){
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                        <button class="btn btn-danger to-delect">Delete</button>
                        </p>
                    </div>
                </div>
            </div>
    ...
    document.querySelector('.to-delete').forEach(function(btn){
  ...
  document.querySelector("#myForm").onsumbit = addNewCard
